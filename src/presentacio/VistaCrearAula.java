...
public class VistaCrearAula extends javax.swing.JFrame
{
     ...
     */
    public VistaCrearAula() {
        initComponents();
    }
    
    public VistaCrearAula(ControladorPresentacio CP) {
        CtrlPresentacio = CP;
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        CtrlPresentacio.sincronitzacioCrearAula_a_GestioAula();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaCrearAula.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaCrearAula().setVisible(true);
            }
        });
    }
